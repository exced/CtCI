...
public class Q2 {
    ...
    public static void main(String[] args) {
        ...
        if (empty.slice(2) != null)
            System.out.println("kth to end singly linkedList empty : " + empty.slice(2).toString());     
        else 
        ...
        if (list1.slice(4) != null)
            System.out.println("kth to end singly linkedList1 : " + list1.slice(4).toString());
        else
